  ...
  return (
    <div className="flex flex-col gap-[24px] animate-in slide-in-from-right-4 duration-300">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-body text-text-secondary">Let's start with the basics of your campaign</p>
      </div>

      <div className="flex flex-col gap-[8px]">
        {/* Campaign Name Card */}
        <div className="bg-white p-[16px] rounded-[16px] border-[0.35px] border-[#0000001A] flex flex-col gap-[12px]">
          <label className="text-label text-text-primary">Campaign Name *</label>
          <input
            type="text"
            ...
            className={`w-full px-5 py-3.5 bg-white border ${errors.name ? 'border-red-500' : 'border-[#F1F5F9]'} rounded-[8px] text-body text-text-primary outline-none focus:border-brand-primary placeholder:text-text-secondary transition-colors`}
          />
        ...
        <div className="bg-white p-[16px] rounded-[16px] border-[0.35px] border-[#0000001A] flex flex-col gap-[12px]">
          <label className="text-label text-text-primary">Campaign Objective *</label>
        ...
        <div className="bg-white p-[16px] rounded-[16px] border-[0.35px] border-[#0000001A] flex flex-col gap-3">
          <label className="text-label text-text-primary">Target Audience *</label>
          <textarea
            ...
            className={`w-full p-[16px] bg-white border ${errors.audience ? 'border-red-500' : 'border-[#F1F5F9]'} rounded-[8px] text-body text-text-primary outline-none focus:border-brand-primary h-[160px] resize-none placeholder:text-text-secondary transition-colors`}
          />
