  ...
  return (
    ...
    >
      <div className="text-center flex flex-col gap-[8px]">
        <h1 className="text-[32px] font-bold text-[#02022C]">Welcome Back</h1>
        <p className="text-[#121212]">Log in to continue creating with AI.</p>
      </div>
    ...
    <div className="flex flex-col gap-[12px]">
          ...
          <p className="text-center text-[14px] leading-[20px] tracking-[-0.15px] text-[#4F4F4F]">
            ...
            <Link href="/signup" className="text-[16px] leading-[24px] tracking-[-0.31px] text-[#02022C] font-semibold hover:text-indigo-500">
              Sign Up
            </Link>
          </p>
    </div>
